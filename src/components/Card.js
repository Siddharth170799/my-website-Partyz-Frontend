  ...
  return (
    <div className="card">
      ...
      <div className="card-content">
        ...
        <p className="card-address">{hall.Address}</p>
        <p className="card-capacity">
          Capacity: <strong>{hall.Capacity}</strong> people
        </p>
        <button className="card-button" onClick={() => bookHall(hall.Name)}>Book Now</button>
      </div>
    </div>
  );
};
